...
@section('title', 'Registration Successful - SalamaPay')
...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.5s ease-out both;">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden text-center">
        ...
        <div class="bg-gradient-to-br from-emerald-500 to-emerald-700 px-8 py-10 relative overflow-hidden">
            ...
            <p class="text-emerald-100 text-sm mt-1">Welcome to SalamaPay</p>
        </div>
        ...
        <div class="p-8">
            <div class="space-y-4">
                <p class="text-sm text-gray-600 leading-relaxed">
                    Your account has been successfully created. You can now log in and start accepting payments.
                </p>
            ...
            <div class="mt-8 space-y-3">
                ...
                <a href="{{ route('login') }}" class="w-full py-2.5 text-sm font-medium text-gray-600 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-xl transition-all flex items-center justify-center gap-2">
