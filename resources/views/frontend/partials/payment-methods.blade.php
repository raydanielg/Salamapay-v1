<section id="payment-methods" class="py-20 md:py-28 bg-gradient-to-b from-emerald-50 to-white">
    <div class="max-w-7xl 2xl:max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12">
        <div class="text-center mb-16">
            ...
            <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-slate-900 mb-4" data-en="Pay Your Way" data-sw="Lipa Kwa Njia Unayopenda">Pay Your Way</h2>
            <p class="text-lg xl:text-xl text-slate-500 max-w-2xl mx-auto" data-en="SalamaPay accepts payments from all payment methods in Tanzania and abroad." data-sw="SalamaPay inakubali malipo kutoka kwenye njia zote za malipo nchini Tanzania na hata ng'ambo.">SalamaPay accepts payments from all payment methods in Tanzania and abroad.</p>
        </div>
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8">
            ...
            <div class="group p-6 rounded-2xl bg-white border border-emerald-100 shadow-sm hover:shadow-xl hover:shadow-emerald-100/50 transition-all duration-300 hover:-translate-y-1 text-center">
                ...
                <h3 class="text-lg xl:text-xl font-bold text-slate-900 mb-2" data-en="Bank & Card" data-sw="Benki & Kadi">Bank & Card</h3>
                <p class="text-sm xl:text-base text-slate-500" data-en="Payments by bank cards and credit cards online." data-sw="Malipo kwa kadi za benki na mikopo kwa njia ya mtandao.">Payments by bank cards and credit cards online.</p>
            </div>
            <div class="group p-6 rounded-2xl bg-white border border-gold-100 shadow-sm hover:shadow-xl hover:shadow-gold-100/50 transition-all duration-300 hover:-translate-y-1 text-center">
                ...
                <h3 class="text-lg xl:text-xl font-bold text-slate-900 mb-2" data-en="Payment Link" data-sw="Payment Link">Payment Link</h3>
                <p class="text-sm xl:text-base text-slate-500" data-en="Send a payment link to your customer anywhere in the world." data-sw="Tuma link ya malipo kwa mteja popote alipo duniani.">Send a payment link to your customer anywhere in the world.</p>
            </div>
        </div>
    </div>
</section>
