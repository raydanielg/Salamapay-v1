    ...
    <nav class="max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-4 lg:px-8 2xl:px-12">
        <div class="flex items-center justify-between h-[72px] lg:h-20 xl:h-24">
            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                <a href="{{ route('pricing') }}" class="group flex items-center gap-1.5 px-3 py-2 xl:px-4 xl:py-2.5 text-[15px] xl:text-base font-semibold text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <span>Pricing</span>
                </a>
                <a href="{{ route('docs') }}" class="group flex items-center gap-1.5 px-3 py-2 xl:px-4 xl:py-2.5 text-[15px] xl:text-base font-semibold text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div class="relative group">
                    <button class="px-3 py-2 xl:px-4 xl:py-2.5 text-[15px] xl:text-base font-semibold text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-1.5">
            ...
            <div class="flex items-center space-x-2">
                <a href="tel:+255000000000" class="hidden lg:inline-flex items-center gap-1 px-3 py-2 xl:px-4 xl:py-2.5 text-[13px] xl:text-sm font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 hover:bg-emerald-100 hover:border-emerald-300 rounded-md transition-all duration-200">
                ...
                <a href="{{ route('login') }}" class="px-4 py-2 xl:px-6 xl:py-3 text-sm xl:text-base font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-md shadow-sm hover:shadow-md transition-all duration-200">
                    Get Started
                </a>
