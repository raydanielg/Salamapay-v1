...
<div class="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 mb-4">
    ...
    <div class="flex gap-1.5 overflow-x-auto pb-1" id="rangeButtons">
        <button data-range="all" onclick="filterSalesRange('all')" class="range-btn px-3 py-2 rounded-lg text-xs font-bold whitespace-nowrap transition-colors {{ request('range','all')==='all' ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">All Time</button>
        <button data-range="today" onclick="filterSalesRange('today')" class="range-btn px-3 py-2 rounded-lg text-xs font-bold whitespace-nowrap transition-colors {{ request('range')==='today' ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">Today</button>
        <button data-range="3d" onclick="filterSalesRange('3d')" class="range-btn px-3 py-2 rounded-lg text-xs font-bold whitespace-nowrap transition-colors {{ request('range')==='3d' ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">3 Days</button>
        <button data-range="7d" onclick="filterSalesRange('7d')" class="range-btn px-3 py-2 rounded-lg text-xs font-bold whitespace-nowrap transition-colors {{ request('range')==='7d' ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">7 Days</button>
        <button data-range="30d" onclick="filterSalesRange('30d')" class="range-btn px-3 py-2 rounded-lg text-xs font-bold whitespace-nowrap transition-colors {{ request('range')==='30d' ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">30 Days</button>
        <button data-range="90d" onclick="filterSalesRange('90d')" class="range-btn px-3 py-2 rounded-lg text-xs font-bold whitespace-nowrap transition-colors {{ request('range')==='90d' ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">90 Days</button>
        <button data-range="this_month" onclick="filterSalesRange('this_month')" class="range-btn px-3 py-2 rounded-lg text-xs font-bold whitespace-nowrap transition-colors {{ request('range')==='this_month' ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}">This Month</button>
    </div>
