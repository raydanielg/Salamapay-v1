...
<tr class="hover:bg-gray-50/50 transition-colors group" data-sale='{{ json_encode([
    ...
    <td class="px-5 py-3.5">
        <div class="flex gap-1.5">
            <button onclick="viewSale(this.closest('tr'))" class="p-1.5 rounded-md bg-blue-50 text-blue-600 border border-blue-200 hover:bg-blue-100 hover:text-blue-700 transition-colors" title="View Receipt">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
            </button>
            <button onclick="deleteSale({{ $sale->id }}, '{{ addslashes($sale->tx_id) }}')" class="p-1.5 rounded-md bg-red-50 text-red-500 border border-red-200 hover:bg-red-100 hover:text-red-700 transition-colors" title="Delete Sale">
