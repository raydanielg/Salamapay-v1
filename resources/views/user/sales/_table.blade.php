...
<tr class="hover:bg-gray-50/50 transition-colors group" data-sale='{{ json_encode([
    ...
    <td class="px-5 py-3.5">
        <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
            <button onclick="viewSale(this.closest('tr'))" class="text-[10px] font-bold text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 px-2 py-1 rounded-md transition-colors">View</button>
        </div>
    </td>
</tr>
@empty
