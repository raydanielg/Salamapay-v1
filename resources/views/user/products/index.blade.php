...
<div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-4">
    ...
    <div class="flex gap-2">
        <button onclick="openProductSettingsModal()" class="px-4 py-2.5 border border-gray-200 text-gray-700 text-xs font-bold rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center gap-1.5 active:scale-95">
