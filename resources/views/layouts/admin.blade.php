...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard - SalamaPay')</title>
        ...
        <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <div class="sidebar-group">
                ...
                <div id="menu-dashboard" class="sidebar-submenu open pl-11 space-y-0.5">
                    ...
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Quick Stats</a>
                </div>
            </div>

            {{-- Merchants --}}
            <div class="sidebar-group">
                <button onclick="toggleMenu('menu-merchants')" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-emerald-100 text-sm font-medium">
                    <svg class="w-5 h-5 text-gold-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                    <span>Merchants</span>
                    <svg class="w-4 h-4 ml-auto transition-transform" id="arrow-merchants" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div id="menu-merchants" class="sidebar-submenu pl-11 space-y-0.5">
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">All Merchants</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Pending Approvals</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">KYC Verification</a>
                </div>
            </div>
            ...
            <div class="sidebar-group">
                ...
                <div id="menu-payments" class="sidebar-submenu pl-11 space-y-0.5">
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">All Transactions</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Pending Payments</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Failed Payments</a>
                </div>
            </div>
            ...
            <div class="sidebar-group">
                ...
                <div id="menu-wallet" class="sidebar-submenu pl-11 space-y-0.5">
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">All Wallets</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Wallet Transactions</a>
            ...
            {{-- Providers --}}
            <div class="sidebar-group">
                <button onclick="toggleMenu('menu-providers')" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-emerald-100 text-sm font-medium">
                    ...
                    <span>Providers</span>
                    <svg class="w-4 h-4 ml-auto transition-transform" id="arrow-providers" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </button>
                <div id="menu-providers" class="sidebar-submenu pl-11 space-y-0.5">
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Active Providers</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Provider Logs</a>
                </div>
            </div>
            ...
            <div class="sidebar-group">
                ...
                <div id="menu-api" class="sidebar-submenu pl-11 space-y-0.5">
                    ...
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">API Logs</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Webhooks</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Webhook Logs</a>
                </div>
            </div>
            ...
            <div class="sidebar-group">
                ...
                <div id="menu-reports" class="sidebar-submenu pl-11 space-y-0.5">
                    ...
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Settlement Reports</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Merchant Reports</a>
                </div>
            </div>
            ...
            <div class="sidebar-group">
                ...
                <div id="menu-settings" class="sidebar-submenu pl-11 space-y-0.5">
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">General Settings</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Payment Settings</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Fee Configuration</a>
            ...
            {{-- Users --}}
            <div class="sidebar-group">
                <button onclick="toggleMenu('menu-users')" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-emerald-100 text-sm font-medium">
                    <svg class="w-5 h-5 text-gold-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                    <span>Users</span>
                ...
                <div id="menu-users" class="sidebar-submenu pl-11 space-y-0.5">
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">All Users</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Roles & Permissions</a>
                    <a href="#" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors">Audit Logs</a>
                </div>
            </div>
        ...
        <div class="p-4 border-t border-emerald-800/50">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-emerald-300/60">Super Admin</p>
                </div>
