...
<body class="font-['Nunito',sans-serif] antialiased bg-gray-50 text-slate-800">
    ...
    <aside id="adminSidebar" class="fixed top-0 left-0 z-50 w-64 h-screen bg-emerald-900 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            {{-- Merchants --}}
            <div class="sidebar-group">
                <button onclick="toggleMenu('menu-merchants')" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-emerald-100 text-sm font-medium {{ request()->routeIs('admin.users*') ? 'active' : '' }}">
                ...
                <div id="menu-merchants" class="sidebar-submenu pl-11 space-y-0.5 {{ request()->routeIs('admin.users*') ? 'open' : '' }}">
                    <a href="{{ route('admin.users') }}" class="block py-1.5 text-xs text-emerald-200/70 hover:text-white transition-colors {{ request()->routeIs('admin.users') ? 'text-white font-medium' : '' }}">All Merchants</a>
                </div>
            </div>
            ...
            {{-- Wallet & Settlements --}}
            <div class="sidebar-group">
                <a href="{{ route('admin.settlements') }}" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-emerald-100 text-sm font-medium {{ request()->routeIs('admin.settlements*') ? 'active' : '' }}">
