...
<body class="font-['Nunito',sans-serif] antialiased bg-gray-50 text-slate-800">
    ...
    <aside id="adminSidebar" class="fixed top-0 left-0 z-50 w-64 h-screen bg-emerald-900 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            {{-- Documentation --}}
            <div class="sidebar-group">
                <a href="{{ route('admin.documentation') }}" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-emerald-100 text-sm font-medium {{ request()->routeIs('admin.documentation*') ? 'active' : '' }}">
            ...
            {{-- Website Templates --}}
            <div class="sidebar-group">
                <a href="{{ route('admin.templates') }}" class="sidebar-link w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-emerald-100 text-sm font-medium {{ request()->routeIs('admin.templates*') ? 'active' : '' }}">
        ...
        <div class="p-4 border-t border-emerald-800/50">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-white truncate">{{ Auth::user()->first_name ? Auth::user()->first_name . ' ' . Auth::user()->last_name : (Auth::user()->name ?? 'Admin User') }}</p>
